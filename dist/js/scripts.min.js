...
optionsSelect();// Если количество чекбоксов больше 5, скрываем их
...
checkboxListToggle();function rangeSliderInit(element) { // создаем функцию инициализации слайдера
...
mobileFilterToggle();
window.addEventListener('resize', mobileFilterToggle, true);// Инициализация слайдера swiper
// https://swiperjs.com/
