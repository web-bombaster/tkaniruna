...
runRangeSliderInit();// клонируем фильтр в переменную
...
mobileFilterToggle();
window.addEventListener('resize', mobileFilterToggle, true);// клонируем фильтр для мобильных в панель
