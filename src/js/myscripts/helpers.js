...
let moving = function () {
    ...
    if (windowWidth <= 768) {
        ...
        movingConstructor('.jsFurnitura .b-bottom', 'append', '.jsFurnitura .b-top__readmore');

        movingConstructor('.jsRecommend .b-bottom', 'append', '.jsRecommend .b-top__readmore');
        ...
        movingConstructor('.jsFurnitura .b02__top', 'append', '.jsFurnitura .b-top__readmore');

        movingConstructor('.jsRecommend .b02__top', 'append', '.jsRecommend .b-top__readmore');
